...
%Here is a simple example of citing references.
Machine learning applications in urban planning have become increasingly important \cite{smith2023machine}, while data science methods continue to evolve for environmental research \cite{anderson2022data}. The development of sustainable transportation networks through multi-objective optimization approaches represents a growing area of research \cite{garcia2024sustainable}.
